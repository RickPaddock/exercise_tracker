...
export const NutritionPage = () => (
  <div className="rick-plan">
    ...
    <div className="section">
      ...
      <div className="rule-box"><p><strong>Which cut goes where — no guessing.</strong> <strong>Chicken breast fillets (1.5kg, ~5 fillets):</strong> the 5 lunches — 900g rubbed Cajun (3 boxes), 600g marinated Greek (2 boxes). <strong>Lean beef mince 5% (650g):</strong> 3 beef-chilli dinners (Mon/Wed/Fri). <strong>Salmon (2 fillets, ~150g each):</strong> 2 salmon dinners (Tue/Thu). <strong>Boneless chicken thighs (600g):</strong> a swap only — cook them instead of the breast on weeks you want a chicken <em>dinner</em> (method in the swap box); otherwise leave them off the shop. Also boil 10 eggs for snacks.</p></div>
      ...
      <div className="step"><div className="step-num">4</div><div className="step-content"><div className="step-time">0:10 — Oven: breast + veg (200°C)</div><div className="step-text">Cajun breast on tray 1, Greek breast on tray 2 — spaced apart, not touching, or it steams. Veg on tray 3, tossed with 2 tbsp olive oil, 1 tsp paprika, 1 tsp garlic powder, ½ tsp salt. In together: <strong>chicken 23–25 min to 75°C internal</strong> (check with the thermometer), veg 20–25 min. Swap the shelves top-to-bottom halfway.</div></div></div>
      ...
      <div className="step"><div className="step-num">8</div><div className="step-content"><div className="step-time">0:45 — Greens for the dinners</div><div className="step-text">Wilt <strong>1kg spinach</strong> with 1 tbsp olive oil + 2 crushed garlic cloves, 5–7 min (if frozen, drain the water off well). Finish with a squeeze of lemon and torn basil. This splits across all 5 dinners.</div></div></div>

      <div className="step"><div className="step-num">9</div><div className="step-content"><div className="step-time">0:55 — Build, cool, label</div><div className="step-text"><strong>5 lunch boxes (with rice):</strong> ~260g rice + one chicken portion (3× Cajun, 2× Greek) + roasted veg. <strong>5 dinner boxes (no rice):</strong> 3× beef chilli over wilted spinach (Mon/Wed/Fri), 2× salmon with steamed broccoli + spinach (Tue/Thu). Leave lids off 20–30 min to vent steam, then seal, write the meal + day on each lid, and fridge.</div></div></div>

      <div className="rule-box"><p><strong>Swap — chicken thigh dinner:</strong> on a week you want chicken at dinner instead of a chilli or salmon night, cook the <strong>600g boneless thighs</strong> in step 4's breast slot. Rub with 1 tbsp olive oil, 1 tsp salt, 1 tsp Italian herbs, 1 tsp paprika, 1 tsp garlic powder, 1 tsp onion powder, ½ tsp chilli flakes, chopped parsley. Bake 200°C, 22–25 min to 75°C. Makes 2–3 dinners — drop that many chilli/salmon nights and serve with greens, no rice.</p></div>
