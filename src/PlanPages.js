...
export const NutritionPage = () => (
  <div className="rick-plan">
    ...
    {/* COOK SEQUENCE */}
    <div className="section">
      <div className="section-title">Sunday Cook — Master Sequence (~60 min, mostly hands-off)</div>

      <div className="rule-box"><p><strong>Set up once, then it runs itself.</strong> Preheat oven to <strong>200°C fan</strong> first. Get out 3 oven trays (line with foil or baking paper = no scrubbing later), 2 saucepans (rice + eggs), 1 big frying pan or wok (beef), a small pan (greens), and your 10 containers + lids. The whole trick: do every bit of prep in step 2 <em>before</em> any pan goes on the heat — chopping and mixing while things cook is what turns a 1-hour Sunday into a stressful 2-hour one.</p></div>

      <div className="step"><div className="step-num">1</div><div className="step-content"><div className="step-time">Night before</div><div className="step-text">Defrost any frozen protein in the fridge. Soak 150g dried chickpeas in cold water. <strong>Marinate the Greek chicken now</strong> (lemon juice, oregano, garlic, olive oil, pinch of salt) — overnight means deeper flavour and one less job in the morning. Mix the dry Cajun rub in a jar too if you like a head start.</div></div></div>

      <div className="step"><div className="step-num">2</div><div className="step-content"><div className="step-time">0:00 — Prep everything (mise en place)</div><div className="step-text">Weigh 500g basmati and rinse until the water runs clear. Season the chicken in two batches: <strong>Cajun</strong> (smoked paprika, garlic + onion powder, oregano, cayenne, salt, pepper, olive oil) and the <strong>Greek</strong> one that's already marinating. Chop the veg (courgette, peppers, half the broccoli). Put the beef spices (cumin, smoked paprika, chilli, garlic) in a small dish. Now nothing needs chopping once the heat's on.</div></div></div>

      <div className="step"><div className="step-num">3</div><div className="step-content"><div className="step-time">0:05 — Hob on: rice + eggs</div><div className="step-text"><strong>Rice:</strong> 500g + 750ml water, bring to the boil, lid on, lowest heat 12 min, then off the heat and rest 10 min — don't lift the lid. <strong>Eggs:</strong> cover 10 eggs with cold water, boil, 9 min simmer, then straight into cold/iced water (peel easier) and fridge in the shell.</div></div></div>

      <div className="step"><div className="step-num">4</div><div className="step-content"><div className="step-time">0:10 — Oven: chicken + veg together</div><div className="step-text">Spread Cajun chicken on tray 1, Greek on tray 2 — spaced out, not crowded, or it steams instead of browning. Toss the veg on tray 3 with olive oil, paprika, garlic, salt. All three in at 200°C: chicken <strong>23–25 min to 75°C internal</strong>, veg ~20 min. Swap the shelves around halfway so everything colours evenly.</div></div></div>

      <div className="step"><div className="step-num">5</div><div className="step-content"><div className="step-time">0:15 — Beef on the hob</div><div className="step-text">Brown the mince in the wok, breaking it up well, then pour off the excess fat. Stir in cumin + smoked paprika (add chilli + garlic for the chilli batch), then a can of diced tomatoes. Simmer 8–10 min until thick and spoonable; stir the cooked chickpeas through if making chilli. Off the heat to cool.</div></div></div>

      <div className="step"><div className="step-num">6</div><div className="step-content"><div className="step-time">0:35 — Chicken: rest, then slice</div><div className="step-text">Check it's 75°C at the thickest part, rest 5 min (keeps it juicy — slicing straight away dries it out), then slice. Pull the veg out and let it cool on the tray.</div></div></div>

      <div className="step"><div className="step-num">7</div><div className="step-content"><div className="step-time">0:38 — Greens</div><div className="step-text">Wilt the spinach in a little olive oil + garlic, 5–7 min if from frozen — drain the water off or the boxes go watery. Finish with lemon and fresh basil.</div></div></div>

      <div className="step"><div className="step-num">8</div><div className="step-content"><div className="step-time">0:45 — Build, cool, label</div><div className="step-text"><strong>5 lunch boxes:</strong> rice + a chicken flavour (or beef) + roasted veg. <strong>5 dinner boxes:</strong> protein + greens, no rice. Leave the lids off 20–30 min so the steam escapes, then seal, write the meal + day on each, and fridge.</div></div></div>

      <div className="warn-box"><p><strong>Food safety:</strong> cool before sealing, eat within Mon–Fri, and freeze anything meant for day 4–5 (move it to the fridge the night before). <strong>Frozen spinach + broccoli:</strong> broccoli first (2–3 min, still firm), spinach after (drain), or the broccoli goes soggy. <strong>Salmon:</strong> cook it fresh (180°C, 18 min) and always eat cold — never reheat.</p></div>
    </div>
