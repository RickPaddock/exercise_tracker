    ...
    <div className="section">
      ...
      <table className="workout">
        <tbody>
          ...
          <tr><td className="ex"><ExLink href="https://musclewiki.com/exercise/machine-rear-delt-fly?model=m">Reverse pec-dec fly</ExLink><div className="cue">chest against pad, lead with elbows, squeeze shoulder blades — rear delts + posture (no machine? bent-over DB reverse fly)</div></td><td className="sets">3 × 12–15</td></tr>
